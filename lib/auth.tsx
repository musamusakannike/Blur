...
interface AuthContextType {
  ...
  updateProfile: (updates: { username?: string; display_name?: string; bio?: string }) => Promise<{ error: any }>;
}
...
const signUp = async (email: string, password: string, username: string) => {
  ...
  const updateProfile = async (updates: { username?: string; display_name?: string; bio?: string }) => {
